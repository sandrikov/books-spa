  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="booksApp.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">
            <Translate contentKey="booksApp.comment.home.createOrEditLabel">Create or edit a Comment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('booksApp.comment.text')}
                id="comment-text"
                name="text"
                data-cy="text"
                type="text"
              ...
              />
              <ValidatedField id="comment-book" name="book" data-cy="book" label={translate('booksApp.comment.book')} type="select">
                <option value="" key="0" />
                {books
