  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="booksApp.book.home.createOrEditLabel" data-cy="BookCreateUpdateHeading">
            <Translate contentKey="booksApp.book.home.createOrEditLabel">Create or edit a Book</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('booksApp.book.title')}
                id="book-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField id="book-author" name="author" data-cy="author" label={translate('booksApp.book.author')} type="select">
                <option value="" key="0" />
                {authors
              ...
              <ValidatedField id="book-genre" name="genre" data-cy="genre" label={translate('booksApp.book.genre')} type="select">
                <option value="" key="0" />
                {genres
